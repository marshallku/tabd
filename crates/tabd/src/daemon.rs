...
async fn process_request(state: &DaemonState, line: &str) -> String {
    ...
    let result = match req.action.as_str() {
        ...
        "wait.download" => waits::handle_wait_download(state, &req.params).await,
        ...
        "monitor.downloads" => monitor::handle_downloads(state, &req.params).await,
        "browser.setDialogPolicy" => monitor::handle_set_dialog_policy(state, &req.params).await,
        "browser.setDownloadDir" => monitor::handle_set_download_dir(state, &req.params).await,
